          ...
          >
            ...
            <motion.div className="pt-16 border-t border-slate-100 space-y-8" variants={fadeInUp}>
              ...
              <div className="flex gap-8">
                <a href={SITE_CONFIG.socialLinks?.instagram} className="flex items-center gap-3 text-slate-400 hover:text-black transition-all group">
                ...
                <a href={SITE_CONFIG.socialLinks?.facebook} className="flex items-center gap-3 text-slate-400 hover:text-black transition-all group">
